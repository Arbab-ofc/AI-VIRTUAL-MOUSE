    ...
    <footer className="mt-16">
      <VintageContainer className="mx-auto max-w-[1400px]" variant="flat" padding="lg">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-3 text-sm text-slate-700">
            <a href="https://github.com" target="_blank" rel="noreferrer" className="flex items-center gap-2 rounded-full px-4 py-2 hover:text-slate-900 hover:bg-[#FFE7C2] retro-shadow">
