    ...
    <VintageContainer padding="lg" className="fade-up">
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between text-sm text-slate-700">
          ...
          <span className="font-semibold text-slate-900">{sensitivity}</span>
        </div>
        <div className="mt-3">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl bg-[#FFE7C2] px-4 py-3 text-sm font-medium text-slate-900 transition-all hover:bg-[#FFD59E] retro-button"
        >
